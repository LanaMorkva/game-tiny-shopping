...
namespace TinyShopping.MainMenu {
    ...
    internal class SelectMenu {
        ...
        private float _itemPadding = 25;
        private Vector2 _itemSize;

        private Rectangle _menuRegion;

        public SelectMenu(Rectangle menuRegion, Vector2 itemSize) {
        ...
        public void AddItem(string text, Action nextScene) {
            _menuItems.Add(new MenuItem(text, nextScene));
            setActiveItem();
        }
