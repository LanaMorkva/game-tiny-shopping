...
namespace TinyShopping.Game {
    ...
    internal class InsectHandler {
        ...
        public void LoadContent(ContentManager content) {
            Colony colony1 = new Colony(_world.GetTopLeftOfTile(3, 33), 150, _world, _pheromoneHandler, _fruitHandler, _world.GetTopLeftOfTile(4, 33), 0, this);
            colony1.Initialize();
            colony1.LoadContent(content);
            Colony colony2 = new Colony(_world.GetTopLeftOfTile(48, 3), 230, _world, _pheromoneHandler, _fruitHandler, _world.GetTopLeftOfTile(46, 5), 1, this);
            colony2.Initialize();
